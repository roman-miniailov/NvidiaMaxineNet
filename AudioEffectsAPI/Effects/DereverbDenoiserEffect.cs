...
// ***********************************************************************
// <copyright file="DereverbDenoiserEffect.cs" company="Roman Miniailov">
//     2022-2023
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace NvidiaMaxine.AudioEffects.Effects
{
    ...
    /// </summary>
    public class DereverbDenoiserEffect : BaseEffect
    {
        /// <summary>
        /// The intensity ratio.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DereverbDenoiserEffect"/> class.
        /// </summary>
        /// <param name="modelDir">The model directory.</param>
        /// <param name="sampleRate">The sample rate.</param>
        public DereverbDenoiserEffect(string modelDir, SampleRate sampleRate)
            : base(modelDir, sampleRate)
        {
            if (sampleRate == SampleRate.SR8000)
            {
                throw new ArgumentException("DereverbDenoiser effect supports 16000 Hz and 48000 Hz.");
            }

            TAG = "DereverbDenoiser";
        }
        ...
        protected override string GetModelName()
        {
            ...
            {
                return "dereverb_denoiser_48k.trtpkg";
            }
            else
            {
                return "dereverb_denoiser_16k.trtpkg";
            }
        }
        ...
        {
            return NvAFXEffectSelectors.NVAFX_EFFECT_DEREVERB_DENOISER;
        }
