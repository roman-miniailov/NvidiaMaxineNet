...
// ***********************************************************************
// <copyright file="NvVFXAPI.cs" company="Roman Miniailov">
//     2022-2023
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace NvidiaMaxine.VideoEffects.API
{
    ...
    public static class NvVFXAPI
    {
        ...
        /// Get the SDK version.
        /// </summary>
        /// <param name="version">Pointer to an unsigned int.</param>
        /// <returns>
        /// NvCVStatus.
        ...
        /// </returns>
        [DllImport(NvVideoEffectsLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern NvCVStatus NvVFX_GetObject(IntPtr effect, string paramName, IntPtr val);
        ...
        /// </returns>
        [DllImport(NvVideoEffectsLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern NvCVStatus NvVFX_GetCudaStream(IntPtr effect, string paramName, out IntPtr val);
        ...
        /// <param name="async_">Run the effect asynchronously if nonzero; otherwise run synchronously.</param>
        /// <returns>
        /// NvCVStatus.
        /// NVCV_SUCCESS if the operation was successful.
        /// NVCV_ERR_EFFECT if an invalid effect handle was supplied.
        /// </returns>
        [DllImport(NvVideoEffectsLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern NvCVStatus NvVFX_Run(IntPtr effect, int async_);
